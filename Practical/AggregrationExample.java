...
class AggregrationExample{ //main class 
	...
	Student s = new Student(1,"mansi","mansi@gmail.com",9943210,i);
	Student s1 = new Student(2,"riya","riya@gmail.com",99852188,i1);
	Student s2 = new Student(3,"mahi","mahi@gmail.com",8892105,i2);
